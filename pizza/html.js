function total() {
  var text = "Confirm your order:" + "<br />";
  var runningTotal = 0;
  var sizeTotal = 0;
  var cheeseTotal = 0;
  ...
  text = text + " " + " " + selectedSize + "<br />"; // + ", $" + sizeTotal + ".00";
  runningTotal = sizeTotal;
  var selectedCrust = document.querySelector('input[name="crust"]:checked')
    .value;
  text = text + selectedCrust + "<br />";
  var selectedSauce = document.querySelector('input[name="sauce"]:checked')
    .value;
